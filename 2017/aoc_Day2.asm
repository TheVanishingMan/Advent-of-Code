...
# The spreadsheet consists of rows and apparently-random numbers. To make sure
# the recovery process is on the right track, we need you to calculate the
# spreadsheet's checksum. For each row, determine the difference between the
# largest value and the smallest value; the checksum is the sum of all
# these differences.

# For example, given the following spreadhsheet:
# 5 1 9 5
# 7 5 3
# 2 4 6 8
